 ...
 */
public class BorderPatches extends SaberPlugin {
    public BorderPatches(Plugin p) {
        super(p);
    }
    ...
    public void enable() {
        super.enable();
        this.registerListener(new BorderPatchesListener(this));
    }
    ...
    static class BorderPatchesListener extends SaberPluginListener<BorderPatches> {

        public BorderPatchesListener(BorderPatches patch) {
            super(patch);
        }
